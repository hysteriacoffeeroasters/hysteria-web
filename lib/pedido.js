...
export const CODIGOS = {
  ...
  'PRUEBA-INTERNA-D1': { tipo: 'fijo', valor: 1, activo: true }, // verificación; se apaga tras probar
};

/* Normaliza y busca un código. Devuelve { codigo, tipo, valor } o null. */
export function leerCodigo(bruto) {
  ...
  const tipo = c.tipo;
  if (tipo === 'enviogratis') return { codigo, tipo, valor: 0 };
